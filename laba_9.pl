...
r_str(X,A,B,N,K):-K1 is K+1,append(B,[X],B1),get0(X1),r_str(X1,A,B1,N,K1).
    ...
    %1
rst :-read_str(A,_),read(K),tell('C:/Users/Rozz/Desktop/лаба.txt'),
				  not(b_a_rp(A,K,[])),told.

b_a_rp(_,0,Perm1):-write_str(Perm1),nl,!,false.
b_a_rp(A,N,Perm):-in_list(A,El),N1 is N-1,b_a_rp(A,N1,[El|Perm]).

all_per:-read_str(A,_),tell('C:/Users/Rozz/Desktop/лаба.txt'),
				not(b_a_p(A,[])),told.
...
all_razm:-read_str(A,_),read(K),tell('C:/Users/Rozz/Desktop/лаба.txt'),
				not(b_a_r(A,K,[])),told.
...
wr_subset:-read_str(A,_),tell('C:/Users/Rozz/Desktop/лаба.txt'),
...
wr_sochet:-read_str(A,_),read(K),tell('C:/Users/Rozz/Desktop/лаба.txt'),
...
wr_sochet_p:-read_str(A,_),read(K),tell('C:/Users/Rozz/Desktop/лаба.txt'),
...
number2:-tell('C:/Users/Rozz/Desktop/лаба.txt'),not(number2),told.
...
in_free_pos([H1,H2,H3,H4,H5],Sim):-(var(H1)->H1 is Sim),!;
       ...
       %3
number_3:-tell('C:/Users/Rozz/Desktop/лаба.txt'),not(number_3_),told.
number_3_:-make_ar(5,Pos),sochet(Pos_a,2,Pos),put_pos(Word,Pos_a,[97]),
       ...
       %4
number_4:-tell('C:/Users/Rozz/Desktop/лаба.txt'),not(number_4_),told.
number_4_:-make_ar(5,Pos),sochet(Pos_simb,2,Pos),in_list([97,98,99,100,101,102],Simbol),
       ...
       %5
number_5:-tell('C:/Users/Rozz/Desktop/лаба.txt'),not(number_5_),told.
...
in_free_pos6([H1,H2,H3,H4,H5,H6],Sim):-(var(H1)->H1 is Sim),!;
      ...
      %6
number_6:-tell('C:/Users/Rozz/Desktop/лаба.txt'),not(number_6_),told.
...
in_free_pos7([H1,H2,H3,H4,H5,H6,H7],Sim):-(var(H1)->H1 is Sim),!;
      ...
      %7
number_7:-tell('C:/Users/Rozz/Desktop/лаба.txt'),not(number_7_),told.
